...
-Adding the carson property and carson object was confusing as heck. I was trying to create a new
variable, and after countless failures I realized the solution was related to nesting. So many curly braces...

How difficult was it to add and delete properties outside of the object itself?
- Adding was simple: I just typed: objectName[property] = value. Deleting it was also pretty simple given 
the "delete" keyword.

What did you learn about manipulating objects in this challenge?
- Conceptually, manipulating objects is similar to manipulating hash keys and values in Ruby.
*/
